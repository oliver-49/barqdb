...
Route::group(['namespace' => 'Api\V1'], function () {
    ...
    Route::get('/configgo', 'ConfigController@configgo');
        ...
        Route::get('healthy', 'ProductController@get_drinks');
        //Route::get('test', 'ProductController@get_test');
        Route::get('restaurantNames', 'ProductController@get_restaurantNames');
    }); 
        ///auth   register login
